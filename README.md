...
3-1 Minecraft Launcher を起動します。

3-2 画面上部の **起動構成** のタブを選択し、**新規作成** をクリックします。

![](Images/fig15.jpg)

3-3 必要事項を記入していきます。</br>
...
3-5 左下の起動構成選択から先程作成したものを選びます。

3-6 選択できたら **プレイ** をクリックしてゲームを開始します。
...
5-2 **リソースの削除** をクリックします。

5-3 削除するにはリソース名を記入します。

5-4 **削除** ボタンがアクティブになるので、これをクリックします。
